...
package biz.shadowservices.DegreesToolbox.TitleBar;


import biz.shadowservices.DegreesToolbox.MainActivity;
...
public class ActivityHelper {
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        ...
        mActivity.getMenuInflater().inflate(R.menu.actionbar, menu);
    ...
    public void setupActionBar(CharSequence title, int color) {
        ...
        Log.d("ActivityHelper", "Setting up bar");
        ...
        if (title != null) {
           ...
           // addActionButtonCompat(R.drawable.ic_title_home, R.string.description_home,
            ...
            // Add logo
            ImageButton logo = new ImageButton(mActivity, null, R.style.ActionBarCompatLogo);
            logo.setOnClickListener(homeClickListener);
            actionBarCompat.addView(logo);
            Log.d("ActivityHelperLogoWidth", String.valueOf(logo.getHeight()));
    ...
    private View addActionButtonCompatFromMenuItem(final MenuItem item) {
       ...
       /* if (item.getItemId() == R.id.refresh_button) {
            ...
            ProgressBar indicator = new ProgressBar(mActivity, null,
                    R.style.ActionBarCompatProgressIndicator);
   ...
   /* public void setRefreshActionButtonCompatState(boolean refreshing) {
        View refreshButton = mActivity.findViewById(R.id.refresh_button);
